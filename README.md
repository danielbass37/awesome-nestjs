...
- [Implement RBAC Authorization in a NestJS](https://www.permit.io/blog/how-to-protect-a-url-inside-a-nestjs-app-using-rbac-authorization) - A guide to securing your Nest.js API endpoints with Role Based Access Control (RBAC) and Attribute Based Access Control (ABAC)
